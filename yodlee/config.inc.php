...
namespace Yodlee\ConfigInc{
	...
	// Url for get itemSummaries
	const URL_GET_TRANSACTIONS = "/jsonsdk/TransactionSearchService/getUserTransactions";
	const URL_USER_SEARCH ="/jsonsdk/TransactionSearchService/executeUserSearchRequest";
	const URL_GET_TRANSACTION_CATEGORIES = "/jsonsdk/TransactionCategorizationService/getUserTransactionCategories";
    // Url Site Account Management: addSiteAccount 
	const URL_ADD_SITE_ACCOUNT = "/jsonsdk/SiteAccountManagement/addSiteAccount";
	//url for get account summaries
	const URL_GET_ACCOUNT_SUMMARIES = "/account/summary/all​";
}
?>